...
class LOTClassTrainer(object):
    ...
    def __init__(self, args):
        ...
        # wobert-base
        self.pretrained_lm = r'E:\PycharmProjects\CCF\pretrained_model\wobert_base'
        self.tokenizer = BertTokenizer.from_pretrained(self.pretrained_lm, do_basic_tokenize=False)

        # wonezha-base
        # self.pretrained_lm = r'E:\PycharmProjects\CCF\pretrained_model\wonezha_base'
        # self.tokenizer = BertTokenizer.from_pretrained(self.pretrained_lm, do_basic_tokenize=False)
    ...
    def filter_keywords(self, category_vocab_size=100):
        ...
        stopwords_vocab = stopwords.words('chinese')
    ...
    def prepare_self_train_data(self, rank, model, idx):
        ...
        # 把input_ids, input_mask, preds移动到cpu()
        ...
        agree = (preds.argmax(dim=-1) == all_target_pred).int().sum().item() / len(all_target_pred)
